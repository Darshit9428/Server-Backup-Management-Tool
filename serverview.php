<?php
    ...
    $uid = $_SESSION['id'];
    $sqlq = "SELECT * FROM user_reg WHERE id = '$uid'";
    $ra = mysqli_query($connection,$sqlq);
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<td>"; echo $row["servername"]; echo "</td>";
                                                echo "<td>"; echo $row["host"]; echo "</td>";
                                                echo "<td>"; echo $row["user"]; echo "</td>";
                                                echo "<td>"; echo $row["pass"]; echo "</td>";
                                                echo "<td><a href='update.php?edit=".$uid."' class='btn btn-success'></i>
                                             Edit</a>
                                                <a href='process.php?delete=".$uid."' class='btn btn-danger'></i>
                                             Delete</a> </td>";
                                                echo "</tr>";
                                            }
                                            ?>
