...
{
    $uid = $_SESSION['id'];
    $sqlr = "SELECT * FROM user_reg WHERE id = '$uid'";
    $ra = mysqli_query($connection,$sqlr);
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-25">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">Statistic</h3>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">Last Backup</h3>
                                       
                                        <div class="alert alert-primary" role="alert">
                                            01-Nov-2018 Backup data Successfully!!
                                        </div>
                                    </div>
                                </div>
                            </div>
